...
import ThiruMalaLogo from "../../../../../assets/images/svg/perumal-svg.svg";
    ...
    <div className="flex flex-col items-center" style={{ zIndex: "2" }}>
      <Avatar
        ...
        sx={{
          ...
          height: "auto",
          my: "3px",
          mb: Lanuage == "en" ? "20px" : "3px",
        }}
      />
      <Avatar
        variant="square"
        src={Lanuage == "en" ? English : Tamil}
        sx={{ width: "48%", height: "auto", my: "3px" }}
      />
      <Avatar
        variant="square"
        src={Lanuage == "en" ? Seng : Stamil}
        sx={{
          width: "25%",
          height: "auto",
          mt: Lanuage == "en" ? "15px" : "3px",
        }}
      />
      <Avatar
        variant="square"
