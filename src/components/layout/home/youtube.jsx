    ...
    <defs>
     ...
     <Slider {...settings} className='w-full'>
       {tnVideoUrl.map((video, index) => (
         <div key={index} className='px-10' style={{padding:"0px 20px"}}>
           {loading ? (
           ...
           <Typography variant='h6' fontWeight={500} mt={1} lineHeight={1.2} className='pt-3 text-white' onClick={(e) => handleOpen(e,video)} sx={{cursor:"pointer"}}>
             {video.name}
           </Typography>
         </div>
       ))}
