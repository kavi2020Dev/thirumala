    ...
    <div className='relative w-full h-56 slider-container'>
     ...
     <div className='flex justify-between items-center'>
      ...
      <div className='flex items-center flex-row-reverse mr-10'>
       <div className='flex'>
       <Avatar variant='square' src={backwardArrow} onClick={previous} sx={{width:"32px",height:"25px",cursor:"pointer"}} disabled={isCondentIndex == data.length-1}/>
         <Avatar variant='square' src={forwardArrow} onClick={next} sx={{width:"32px",height:"25px",cursor:"pointer", ml:0.5}} disabled={isCondentIndex == 0}/>
